    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        JSONArray earthquakeArray = baseJSONResponse.getJSONArray("features");
            ...
            for(int i = 0; i < earthquakeArray.length(); i++) {
                ...
                long tempValue =  Long.parseLong(properties.getString("time"));
                Date dateObject = new Date(tempValue);
                ...
                if (location.contains(LOCATION_SEPARATOR)) {
                    ...
                    locationOffset = Integer.toString(R.string.near_the);
                    primaryLocation = location;
                }


                Earthquake tempEarthquake = new Earthquake(magnitude,locationOffset,primaryLocation,dateToDisplay,url);
